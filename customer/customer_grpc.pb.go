...
type CustomerServiceClient interface {
	...
	GetCustomers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CustomerList, error)
}
...
func (c *CustomerServiceClient) GetCustomers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CustomerList, error) {
...
type CustomerServiceServer interface {
	...
	GetCustomers(context.Context, *Empty) (*CustomerList, error)
...
func (UnimplementedCustomerServiceServer) GetCustomers(context.Context, *Empty) (*CustomerList, error) {
...
func _CustomerService_GetCustomers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
